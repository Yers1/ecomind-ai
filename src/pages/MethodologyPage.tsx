  ...
  return (
    <div className="methodology-page page-surface">
      ...
      <div className="container method-content">
        ...
        <section className="future-data"><h2>Materials and certifications</h2><p>Certifications can strengthen evidence, but their absence does not necessarily mean a product performs poorly. Only relevant, verifiable environmental certifications can add a small adjustment to the Green Score. Social and labour certifications are shown separately under People information.</p><p>The adjustment is +2 for one independently relevant verified environmental certification and no more than +3 for multiple certifications. Aliases are deduplicated; seller claims and vague marketing language receive zero points; missing certification creates no penalty. Certifications never replace missing carbon or packaging evidence.</p><p>The +3 cap is a prototype assumption requiring expert validation. Fair Trade Certified is currently recognised as People information and does not increase the environmental score.</p></section>
