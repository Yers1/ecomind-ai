  ...
  return (
    <div className="privacy-page page-surface">
      ...
      <div className="container privacy-content">
        ...
        <section className="data-choice"><div><h2>Your choices stay in your control</h2><p>The prototype does not sell shopping history. You can use one product analysis before creating a demo profile.</p><div className="data-choice__list"><span><CheckCircle size={18} weight="fill" /> Analyse as a guest</span><span><CheckCircle size={18} weight="fill" /> Choose whether to save</span><span><CheckCircle size={18} weight="fill" /> Remove wishlist items</span><span><CheckCircle size={18} weight="fill" /> Clear local storage in your browser</span></div></div><div className="local-storage-card"><Cookie size={31} weight="duotone" /><h3>Local prototype storage</h3><p><code>ecomind-ai-demo-state-v1</code></p><small>Stores wishlist IDs, demo points, completed actions and demo sign-in state.</small></div></section>
        <section className="extension-future"><div className="extension-future__icon"><LockKey size={28} /></div><div><h2>A real extension would request minimum permissions</h2><p>Only the active product page should be read after user activation. Permission scope, retention and deletion controls would need independent security and privacy review.</p></div></section>
